...
const AiChatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<{role: 'user' | 'model', text: string}[]>([
    { role: 'model', text: "Hi! I'm Rentura's AI assistant. How can I help you optimize your rental experience today?" }
  ]);
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const chat: Chat = ai.chats.create({
        ...
        config: {
          systemInstruction: RENTURA_CONTEXT,
        },
      ...
      setMessages(prev => [...prev, { role: 'model', text: "I'm having a little trouble connecting to the server right now. Please try again later." }]);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Input Area */}
            <form onSubmit={handleSend} className="p-4 border-t border-border-base bg-page/50">
